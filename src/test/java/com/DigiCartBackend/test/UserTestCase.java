...
public class UserTestCase {
	...
	@Test
	 ...
	 user=userDao.getUserByEmail("shubham341.@gmail.com");
	 assertEquals("Successfully fetched a supplier details from the table","Shubham R D", user.getName());
	 }
	...
	public void testDeleteUser() {
		assertEquals("Successfully deleted supplier details from the table", true, userDao.deleteUser("shubham341.rd@gmail.com"));
	}
	@Test
